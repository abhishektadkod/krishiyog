      ...
      <div><h3>Seller Enquiry Form</h3></div>
             ...
             <form name="sellerForm" action="sellerEnqdb.php" onsubmit="return(validate())" method="post" style="padding:10px;margin-left:30px;margin-right:30px;">
               <div class="row form-group">
                 ...
                 <hr>
                 <h3>KYC FORM</h3>
                 <div class="row form-group"><!--For a single row it should be divided into 3 text fields-->
                   <div class="col-md-4">
             ...
             <input type="button" value="Remove Item" class="btn btn-danger" onClick="deleteRow('dataTable')"  />
               ...
               <td>
                 ...
                 <input type="text" placeholder="Item" class="form-control" required="required" name="BX_Item[]">
 							 ...
 							 <td >
                 <td >
                 <label for="BX_quantity"></label>
                 <input type="text" placeholder="Quantity" class="form-control" required="required" name="BX_quantity[]">
                  </td>
                  <td >
   								<label for="BX_type"></label>
   								<select id="BX_type" name="BX_type[]" class="form-control"  required="required">
   									<option selected disabled="disabled">Unit</option>
                 ...
                 <td >
                 <label for="BX_totalprice"></label>
                 <input type="text" placeholder="Total Price" class="form-control" required="required" name="BX_totalprice[]">
                  </td>
                </p>
                      </tr>
                      </tbody>
